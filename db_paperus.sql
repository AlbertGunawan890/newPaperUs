...
CREATE TABLE `master_pengiriman` (
  ...
  `deleted_at` timestamp NULL DEFAULT NULL,
  `status_pengiriman` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`no_spk`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `master_pengiriman` */

insert  into `master_pengiriman`(`no_spk`,`no_surat_jalan`,`no_kendaraan`,`nama_pengiriman`,`nama_penerima`,`alamat_penerima`,`qty`,`tanggal`,`deleted_at`,`status_pengiriman`) values
('SP001','Los angeles','1','asd','12 8 Let It Be','Los angeles','12','2023-05-16',NULL,1);
