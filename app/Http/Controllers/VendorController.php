    ...
    public function doEdit(Request $req)
    {
        $req->validate(
            ...
            [
                ...
                "jenis_item.required" => 'Jenis Item Harus Terisi',
                "kategori.required" => 'Nomor Kategori Harus Terisi',
                "alamat.required"=> 'Email Harus Terisi',
            ]
        );

        $vendor = Vendor::withTrashed()->find($req->id_vendor);
        $res = $vendor->update([
            "nama_vendor" => $req->nama,
            "jenis_item" => $req->jenis_item,
            "kategori_vendor" => $req->kategori,
